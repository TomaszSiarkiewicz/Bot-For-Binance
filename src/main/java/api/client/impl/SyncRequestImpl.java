...
import api.client.model.spot.wallet.AccountStatus;
import api.client.model.spot.wallet.DepositHistory;
import api.client.model.spot.wallet.SystemStatus;
import api.client.model.spot.wallet.WidthrawHistory;
import com.alibaba.fastjson.JSONObject;
import api.client.SyncRequestClient;
import api.client.model.ResponseResult;
import api.client.model.market.*;
import api.client.model.enums.*;
import api.client.model.trade.*;
...
public class SyncRequestImpl implements SyncRequestClient {
    ...
    public AccountStatus getAccountStatus(Long timestamp){
        return RestApiInvoker.callSync(requestImpl.getAccountStatus(timestamp));
    }
    @Override
    ...
    public List<WidthrawHistory> getWidthrawHistory(Long timestamp){
        return RestApiInvoker.callSync(requestImpl.getWidthrawHistory(timestamp));
    }
